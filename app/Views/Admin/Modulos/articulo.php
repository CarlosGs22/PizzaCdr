						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" id="nombre" name="nombre" class="form-control" placeholder="Nombre" maxlength="255" required>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<label for="cantidad"> Cantidad: <span class="text-danger">*</span> </label>
									<input type="number" id="cantidad" name="cantidad" class="form-control" placeholder="Cantidad" maxlength="11" number="true" required>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<label for="gr"> Gr: <span class="text-danger">*</span> </label>
									<input type="number" id="gr" name="gr" class="form-control" placeholder="Gr" maxlength="1" number="true" required>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									<label for="lt"> Lt: <span class="text-danger">*</span> </label>
									<input type="number" id="lt" name="lt" class="form-control" placeholder="Lt" maxlength="1" number="true" required>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="number" id="status" name="status" class="form-control" placeholder="Status" maxlength="11" number="true" required>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									<label for="cveFecha"> Cve fecha: <span class="text-danger">*</span> </label>
									<input type="date" id="cveFecha" name="cveFecha" class="form-control" dateISO="true" required>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<label for="cveUsuario"> Cve usuario: <span class="text-danger">*</span> </label>
									<input type="number" id="cveUsuario" name="cveUsuario" class="form-control" placeholder="Cve usuario" maxlength="4" number="true" required>
								</div>
							</div>
						</div>
...
function edit(id) {
	$.ajax({
		...
		success: function(response) {
			...
			$("#edit-form #nombre").val(response.nombre);
			$("#edit-form #cantidad").val(response.cantidad);
			$("#edit-form #gr").val(response.gr);
			$("#edit-form #lt").val(response.lt);
			$("#edit-form #precio").val(response.precio);
			$("#edit-form #status").val(response.status);
			$("#edit-form #cveFecha").val(response.cve_fecha);
			$("#edit-form #cveUsuario").val(response.cve_usuario);
