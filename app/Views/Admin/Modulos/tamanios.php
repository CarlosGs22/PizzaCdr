        ...
        <div class="row">
            ...
            <div class="col-6 col-md-6 col-sm-6 text-right">
                <h3 class="text-blue h3">
                    <button type="button" class="btn btn_add_tamanios" data-toggle="modal" data-target="#modal_tamanios" data-bgcolor="#007bb5" data-color="#ffffff" style="color: rgb(255, 255, 255); background-color: rgb(0, 123, 181);"><i class="fa fa-plus"></i> Nuevo</button>
            ...
            <div class="row">
                    ...
                    <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <form class="form-inline" action="<?php echo base_url("admin/tamanios") ?>" accept-charset="UTF-8" method="get">
                                        <div class="flex-fill mr-2">
                                            <input type="text" name="txtBuscar" id="txtBuscar" value="" placeholder="Tamaño" class="form-control w-100" required>
                                        </div>
                    ...
                    <div class="row pd-20">
                        <?php if ($lista_tamanios) {
                            foreach ($lista_tamanios as $key => $value) { ?>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-4 mb-30">
                                        ...
                                        <div class="card-body text-center">
                                            ...
                                            <div class="row mb-30 mt-30">
                                                ...
                                                <div class="col-lg-12 mb-20">
                                                    <img src="<?php echo base_url("public/Admin/img/tamanios/" . $value['imagen']) ?>" alt="Tamaño" style="max-width: 80%; height:20vh;">
                                                </div>
                                            </div>
                                            <div class="row">
            ...
            <div class="modal-body">
                <form method="post" action="<?php echo base_url("admin/accion_tamanios") ?>" enctype="multipart/form-data" id="frm_tamanio">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input type="file" id="imgTamanio" name="imgTamanio" class="form-control-file form-control height-auto" accept=".jpg, .jpeg, .png">
                        </div>
                    </div>
...
<script>
    $(function() {
        ...
        if (idTamanio == '1'|| localStorage.getItem("opcionBtn") === '1') {
        ...
        $(".btn_add_tamanios").click(function() {

            if (idTamanio == '1') {
                localStorage.setItem("opcionBtn", "1");
                window.location.href = "<?php echo base_url("admin/tamanios"); ?>";
            }
        });
        ...
        $("#frm_tamanio").submit(function(e) {
            e.preventDefault();

            var valid = false;

            if (validacionInput("frm_tamanio")) {
                if (validacionSelect("frm_tamanio")) {
                    valid = true;
                }
            }
