    ...
    <div class="col-lg-8  col-md-8 col-sm-12 mb-30">
        ...
        <div class="row">
            ...
            ?>
                            ...
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6" id="<?= $key ?>">
                                            ...
                                            <div class="col-12 pb-20">
                                                <div class="card-box pricing-card card mt-30  h-100 cardProductos">
                                                    <div class="price-title textoTipo divText">
                                                        <?= $value["nombre_menu"] . " - " . $value["tamanio"]  ?> <i class="icon-copy fa fa-check-circle" aria-hidden="true"></i>
                                                    </div>
                                                                ...
                                                                <?php for ($i = 0; $i < $value["total_productol"]; $i++) {   ?>
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="prod_exis<?= ($i + 1) ?>" class="form-control">
                                                                            <?php
                                                                            $lista["listas_producto_existente"] = $productos_modelo->_getProductosPublic(NULL, session()->get("id_sucursal"), "9999", null, $value["idTipoTamanio"]);
