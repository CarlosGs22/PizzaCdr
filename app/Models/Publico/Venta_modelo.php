...
class Venta_modelo extends Model
{
    ...
    protected $allowedFields = [
        ...
        'contacto', 'precio_envio', 'tipo_orden',
    ...
    {
        $this->select('venta.id, venta.fecha,count(detalle_venta.id_venta) as cantidad,venta.total,tipo_orden.tipo, status_venta.nombre as nombreStatus,badge')
